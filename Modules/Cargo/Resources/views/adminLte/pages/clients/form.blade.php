...
<div class="row mb-6">
    ...
    <div class="col-lg-6 fv-row">
        ...
        <div class="input-group mb-4">
            ...
            <input type="hidden" class="country_code country_code_1" name="country_code" value="{{ old('country_code', isset($model) ? $model->country_code : '') }}" data-reflection="phone">
...
<div class="row mb-6">
    ...
    <div class="col-lg-6 fv-row">
        ...
        <div class="input-group mb-4">
            ...
            <input type="hidden" class="country_code  country_code_2 " name="follow_up_country_code" value="{{ old('follow_up_country_code', isset($model) ? $model->follow_up_country_code : '') }}" data-reflection="phone">
