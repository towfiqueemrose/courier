                ...
                <div class="form-group">
                    ...
                    @if($user_role == $auth_client)
                        @if($typeForm == 'create')
                            ...
                            <input type="hidden" class="country_code country_code_1" name="Shipment[country_code]" value="{{$userClient->country_code ?? '+234'}}" data-reflection="phone">
                        @elseif($typeForm == 'edit')
                            ...
                            <input type="hidden" class="country_code country_code_1" id="country_code" name="Shipment[country_code]" value="{{ old('country_code', isset($model) ? $model->country_code : '+234') }}" data-reflection="phone">
                        @endif
                    @else
                        <input type="tel" name="Shipment[client_phone]" placeholder="{{ __('cargo::view.client_phone') }}"  id="client_phone" value="{{ old('Shipment.client_phone', isset($model) ? $model->country_code.$model->client_phone : '' ) }}" class="phone_input phone_input_1  number-only  form-control @error('Shipment.client_phone') is-invalid @enderror" />
                        <input type="hidden" class="country_code country_code_1" id="country_code" name="Shipment[country_code]" value="{{ old('country_code', isset($model) ? $model->country_code : '+234') }}" data-reflection="phone">
