    ...
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('login.request') }}" novalidate="novalidate" id="kt_sign_in_form">
        ...
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="email" id="email" placeholder="{{ __('view.Email') }}" autocomplete="off" value="{{ old('email', '') }}" required autofocus>
